        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductLasering"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductLasering" 
                        v-model="formData.numberOfProducedProductLasering"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductLaseringValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endLaseringTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endLaseringTimeAndDate" v-model="formData.endLaseringTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endLaseringTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductLasering:'',
        numberOfProducedProductLaseringValidate:'',
        machinsParticipant:'',
        ...
        endLaseringTimeAndDate:'',
        endLaseringTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductLasering === ""){
            formData.numberOfProducedProductLaseringValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductLaseringValidate = ''
        }
        ...
        if(formData.endLaseringTimeAndDate === ""){
            formData.endLaseringTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endLaseringTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductLasering !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endLaseringTimeAndDate !== ""){
          endOfPO()
        }
    }

    ...
    <div class="card-block">
        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="">
                      <div v-if=" startLaseringPO.startTimeAndDate==''" class="form-group">
                      <label class="font-medium-5 d-block text-center" for="startLaseringPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <date-picker type='datetime' color="#03a9f4" id="startLaseringPOTimeAndDate" v-model="startLaseringPO.startTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                            {{startLaseringPO.startTimeAndDateValidate}}
                        </div>
                      </div>
                      ...
                      <div v-if="startLaseringPO.startTimeAndDate!=''" class="form-group">
                        <label class="font-medium-5 d-block text-center" for="startLaseringPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <input id="startLaseringPOTimeAndDate" type="text" class="form-control position-relative" v-model="startLaseringPO.startTimeAndDate" disabled>   
                        <div class="form-text text-danger">
                        {{startLaseringPO.startTimeAndDateValidate}}
                        </div>           
                      </div>
...
export default {
    ...
    methods:{
        startDate(){
          if(this.startLaseringPO.startTimeAndDate==''){
            document.querySelector('#startLaseringPOTimeAndDate').disabled= 'disabled'
          }
        },
...
setup(){
    ...
    function validate(){
        ...
        if(this.startLaseringPO.startTimeAndDate === ""){
            this.startLaseringPO.startTimeAndDateValidate = "تعداد ورق نباید خالی باشد!"
        }
        else{
            this.startLaseringPO.startTimeAndDateValidate = ''
        }
    }

  ...
  <div>
    <div class="card m-2">
        <div class="card-header">
            <h2 class="text-center">تحویل ورق به مرحله بعدی</h2>
        </div>
                ...
                <div class="card p-2">
                  ...
                  <div class="row mb-3">
                      <div class="form-group col-md-11">
                          <div >                        
                              <select @change="correctionSumOfDelivered1() && getRollsAndSheetsList() && getStoringCodes()" class="form-select form-select-lg" id="sheetDeliveredPlace1" v-model="formData.sheetDeliveredPlace1" aria-expanded="false">
                  ...
                  <hr v-if="formData.sheetDeliveredPlace1 == 'cutting'">
      
      
                  <div v-if="formData.sheetDeliveredPlace1 == 'storage'" class="row mb-3">
                    <!-- <label class="form-control-lg" for="storingCode">کد انبارش</label> -->
                    <div class="col-md-6">
                      <select
                        class="form-select form-select-lg"
                        id="storingCode1"
                  ...
                  <hr v-if="formData.sheetDeliveredPlace1 == 'storage'">
      
                  <div v-if="sheetDeliveredPlaceRow < 3">
                  <div class="row mb-3">
                      <div class="form-group col-md-11">
                          <div >                        
                              <select @change="correctionSumOfDelivered2" class="form-select form-select-lg" id="sheetDeliveredPlace2" v-model="formData.sheetDeliveredPlace2" aria-expanded="false" required>
                              <option value="">محل تخصیص ورق را وارد کنید</option>
                              <option value="cutting">برشکاری از رول یا شیت</option>
                              <option value="storage">انبار</option>
                              </select>                        
                  ...
                  <div v-if="formData.sheetDeliveredPlace2 == 'cutting'" class="row mb-3">
                    <!-- <label class="form-control-lg" for="rollID">کد رول/شیت </label> -->
                    <div class="col-md-6">
                      <!-- <select
                        class="form-select-lg form-select"
                  ...
                  <hr v-if="formData.sheetDeliveredPlace2 == 'cutting'">
                  ...
                  <hr v-if="formData.sheetDeliveredPlace2 == 'storage'">
      ...
      <div v-if="sheetDeliveredPlaceRow < 2">
                  <div class="row mb-3">
                      <div class="form-group col-md-11">
                          <div >                        
                              <select @change="correctionSumOfDelivered3" class="form-select form-select-lg" id="sheetDeliveredPlace3" v-model="formData.sheetDeliveredPlace3" aria-expanded="false" required>
                              <option value="">محل تخصیص ورق را وارد کنید</option>
                              <option value="cutting">برشکاری از رول یا شیت</option>
                              <option value="storage">انبار</option>
                              </select>                        
...
return{
    ...
    methods:{
        ...
        sheetDeliveredPlaceFunc1(){
            this.sheetDeliveredPlace1 = document.querySelector('#sheetDeliveredPlace1').value;
        },

        sheetDeliveredPlaceFunc2(){
            this.sheetDeliveredPlace2 = document.querySelector('#sheetDeliveredPlace2').value;
        },

        sheetDeliveredPlaceFunc3(){
            this.sheetDeliveredPlace3 = document.querySelector('#sheetDeliveredPlace3').value;
        }, 
...
setup(){
    const formData = reactive({
      subLevel : 'sheetDeliveredCutting',
      orderProductID: '',
      rollOrSheet1:'',
      rollOrSheet2:'',
      rollOrSheet3:'',
    ...
    async function getStoringCodes() {
    ...
    async function getRollsAndSheetsList() {
        ...
        async function submitForm() {
          ...
          formData.numberOfSheetDeliveredCutting1 == 0) {
            ...
            if(formData.numberOfSheetDeliveredCutting1 == ""){
              validateData.numberOfSheetDeliveredCutting1 = "تعداد ورق ارسالی را وارد کنید!";
            }
            else validateData.numberOfSheetDeliveredCutting1 = "";
          } 

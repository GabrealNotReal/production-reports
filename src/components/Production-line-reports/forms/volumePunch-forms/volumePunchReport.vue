        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductVolumePunch"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductVolumePunch" 
                        v-model="formData.numberOfProducedProductVolumePunch"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductVolumePunchValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endVolumePunchTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endVolumePunchTimeAndDate" v-model="formData.endVolumePunchTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endVolumePunchTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductVolumePunch:'',
        numberOfProducedProductVolumePunchValidate:'',
        machinsParticipant:'',
        ...
        endVolumePunchTimeAndDate:'',
        endVolumePunchTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductVolumePunch === ""){
            formData.numberOfProducedProductVolumePunchValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductVolumePunchValidate = ''
        }
        ...
        if(formData.endVolumePunchTimeAndDate === ""){
            formData.endVolumePunchTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endVolumePunchTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductVolumePunch !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endVolumePunchTimeAndDate !== ""){
          endOfPO()
        }
    }

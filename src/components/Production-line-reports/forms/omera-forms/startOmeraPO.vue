    ...
    <div class="card-block">
        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="">
                      <div v-if=" startOmeraPO.startTimeAndDate==''" class="form-group">
                      <label class="font-medium-5 d-block text-center" for="startOmeraPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <date-picker type='datetime' color="#03a9f4" id="startOmeraPOTimeAndDate" v-model="startOmeraPO.startTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                            {{startOmeraPO.startTimeAndDateValidate}}
                        </div>
                      </div>
                      ...
                      <div v-if="startOmeraPO.startTimeAndDate!=''" class="form-group">
                        <label class="font-medium-5 d-block text-center" for="startOmeraPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <input id="startOmeraPOTimeAndDate" type="text" class="form-control position-relative" v-model="startOmeraPO.startTimeAndDate" disabled>   
                        <div class="form-text text-danger">
                        {{startOmeraPO.startTimeAndDateValidate}}
                        </div>           
                      </div>
...
export default {
    ...
    methods:{
        startDate(){
          if(this.startOmeraPO.startTimeAndDate==''){
            document.querySelector('#startOmeraPOTimeAndDate').disabled= 'disabled'
          }
        },
...
setup(){
    ...
    function validate(){
        ...
        if(this.startOmeraPO.startTimeAndDate === ""){
            this.startOmeraPO.startTimeAndDateValidate = "تعداد ورق نباید خالی باشد!"
        }
        else{
            this.startOmeraPO.startTimeAndDateValidate = ''
        }
    }

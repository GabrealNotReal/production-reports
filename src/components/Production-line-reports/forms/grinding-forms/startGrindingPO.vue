    ...
    <div class="card-block">
        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="">
                      <div v-if=" startGrindingPO.startTimeAndDate==''" class="form-group">
                      <label class="font-medium-5 d-block text-center" for="startGrindingPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <date-picker type='datetime' color="#03a9f4" id="startGrindingPOTimeAndDate" v-model="startGrindingPO.startTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                            {{startGrindingPO.startTimeAndDateValidate}}
                        </div>
                      </div>
                      ...
                      <div v-if="startGrindingPO.startTimeAndDate!=''" class="form-group">
                        <label class="font-medium-5 d-block text-center" for="startGrindingPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <input id="startGrindingPOTimeAndDate" type="text" class="form-control position-relative" v-model="startGrindingPO.startTimeAndDate" disabled>   
                        <div class="form-text text-danger">
                        {{startGrindingPO.startTimeAndDateValidate}}
                        </div>           
                      </div>
...
export default {
    ...
    methods:{
        startDate(){
          if(this.startGrindingPO.startTimeAndDate==''){
            document.querySelector('#startGrindingPOTimeAndDate').disabled= 'disabled'
          }
        },
...
setup(){
    ...
    function validate(){
        ...
        if(this.startGrindingPO.startTimeAndDate === ""){
            this.startGrindingPO.startTimeAndDateValidate = "تعداد ورق نباید خالی باشد!"
        }
        else{
            this.startGrindingPO.startTimeAndDateValidate = ''
        }
    }

        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductGrinding"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductGrinding" 
                        v-model="formData.numberOfProducedProductGrinding"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductGrindingValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endGrindingTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endGrindingTimeAndDate" v-model="formData.endGrindingTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endGrindingTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductGrinding:'',
        numberOfProducedProductGrindingValidate:'',
        machinsParticipant:'',
        ...
        endGrindingTimeAndDate:'',
        endGrindingTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductGrinding === ""){
            formData.numberOfProducedProductGrindingValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductGrindingValidate = ''
        }
        ...
        if(formData.endGrindingTimeAndDate === ""){
            formData.endGrindingTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endGrindingTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductGrinding !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endGrindingTimeAndDate !== ""){
          endOfPO()
        }
    }

        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductStraightening"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductStraightening" 
                        v-model="formData.numberOfProducedProductStraightening"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductStraighteningValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endStraighteningTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endStraighteningTimeAndDate" v-model="formData.endStraighteningTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endStraighteningTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductStraightening:'',
        numberOfProducedProductStraighteningValidate:'',
        machinsParticipant:'',
        ...
        endStraighteningTimeAndDate:'',
        endStraighteningTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductStraightening === ""){
            formData.numberOfProducedProductStraighteningValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductStraighteningValidate = ''
        }
        ...
        if(formData.endStraighteningTimeAndDate === ""){
            formData.endStraighteningTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endStraighteningTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductStraightening !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endStraighteningTimeAndDate !== ""){
          endOfPO()
        }
    }

        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductDrawing"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductDrawing" 
                        v-model="formData.numberOfProducedProductDrawing"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductDrawingValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endDrawingTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endDrawingTimeAndDate" v-model="formData.endDrawingTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endDrawingTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductDrawing:'',
        numberOfProducedProductDrawingValidate:'',
        machinsParticipant:'',
        ...
        endDrawingTimeAndDate:'',
        endDrawingTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductDrawing === ""){
            formData.numberOfProducedProductDrawingValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductDrawingValidate = ''
        }
        ...
        if(formData.endDrawingTimeAndDate === ""){
            formData.endDrawingTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endDrawingTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductDrawing !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endDrawingTimeAndDate !== ""){
          endOfPO()
        }
    }

    ...
    <div class="card-block">
        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="">
                      <div v-if=" startDrawingPO.startTimeAndDate==''" class="form-group">
                      <label class="font-medium-5 d-block text-center" for="startDrawingPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <date-picker type='datetime' color="#03a9f4" id="startDrawingPOTimeAndDate" v-model="startDrawingPO.startTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                            {{startDrawingPO.startTimeAndDateValidate}}
                        </div>
                      </div>
                      ...
                      <div v-if="startDrawingPO.startTimeAndDate!=''" class="form-group">
                        <label class="font-medium-5 d-block text-center" for="startDrawingPOTimeAndDate">تاریخ و ساعت شروع کار</label>
                        <input id="startDrawingPOTimeAndDate" type="text" class="form-control position-relative" v-model="startDrawingPO.startTimeAndDate" disabled>   
                        <div class="form-text text-danger">
                        {{startDrawingPO.startTimeAndDateValidate}}
                        </div>           
                      </div>
...
export default {
    ...
    methods:{
        startDate(){
          if(this.startDrawingPO.startTimeAndDate==''){
            document.querySelector('#startDrawingPOTimeAndDate').disabled= 'disabled'
          }
        },
...
setup(){
    ...
    function validate(){
        ...
        if(this.startDrawingPO.startTimeAndDate === ""){
            this.startDrawingPO.startTimeAndDateValidate = "تعداد ورق نباید خالی باشد!"
        }
        else{
            this.startDrawingPO.startTimeAndDateValidate = ''
        }
    }

        ...
        <div class="card-body">
            <form @submit.prevent="validate">
                ...
                <div class="form-group">
                        <label 
                        class="font-medium-5 d-block text-center"
                        for="numberOfProducedProductPackaging"
                         >تعداد محصول
                        </label>
                        <input 
                        type="number" 
                        class="form-control position-relative input-lg" 
                        id="numberOfProducedProductPackaging" 
                        v-model="formData.numberOfProducedProductPackaging"
                        placeholder="تعداد محصول تولید شده را وارد کنید" 
                        >
                        <div class="form-text text-danger">
                        {{formData.numberOfProducedProductPackagingValidate}}
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div >
                          ...
                          <div class="form-group">
                            <label class="font-medium-5 d-block text-center" for="endPackagingTimeAndDate">تاریخ و ساعت خاتمه کار</label>
                            <date-picker color="#03a9f4" type='datetime' id="endPackagingTimeAndDate" v-model="formData.endPackagingTimeAndDate"></date-picker>
                        <div class="form-text text-danger">
                        {{formData.endPackagingTimeAndDateValidate}}
                        </div>
                          </div>
                    </div>    
...
setup(){
  ...
  const formData = reactive({
        ...
        numberOfProducedProductPackaging:'',
        numberOfProducedProductPackagingValidate:'',
        machinsParticipant:'',
        ...
        endPackagingTimeAndDate:'',
        endPackagingTimeAndDateValidate:'',
    ...
    function validate(){
        ...
        if(formData.numberOfProducedProductPackaging === ""){
            formData.numberOfProducedProductPackagingValidate = "تعداد محصول نباید خالی باشد!"
        }
        else{
            formData.numberOfProducedProductPackagingValidate = ''
        }
        ...
        if(formData.endPackagingTimeAndDate === ""){
            formData.endPackagingTimeAndDateValidate = "تاریخ و ساعت خاتمه کار باید مشخص شود!"
        }
        else{
            formData.endPackagingTimeAndDateValidate = ''
        }

        if(formData.orderProduct !== "" && formData.numberOfProducedProductPackaging !== "" && formData.machinsParticipant !== "" && formData.staffParticipant !== "" && formData.endProductionReason === "6" && formData.endPackagingTimeAndDate !== ""){
          endOfPO()
        }
    }
